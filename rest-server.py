...
def getPrediction():
    ...
    try:
        ...
        if labelledImage is not None:
            ...
            #ik = ig.replace('b\'', '')
            numberPlateVal = detect_license_plate(croppedImagepath)
            if len(numberPlateVal) >= 1:
                ...
                responseDict = {"numberPlateVal": numberPlateVal}
            ...
            # responseDict = {"base64Image": "Unknown", "partDetails" : "Unknown", "numberPlateVal": "Unknown"}
            responseDict = {"base64Image": "Unknown", "numberPlateVal": "Unknow"}
            # responseList.append(responseDict)
            # print(responseDict)
            # convert to json data
            jsonStr = json.dumps(responseDict, ensure_ascii=False).encode('utf8')
        ...
        print(e)
    # responseDict = {"base64Image": "Unknown", "partDetails": "Unknown", "numberPlateVal": "Unknown"}
    responseDict = {"base64Image": "Unknown", "numberPlateVal": "Un"}
    # responseList.append(responseDict)
    # print(responseDict)
    # convert to json data
    jsonStr = json.dumps(responseDict, ensure_ascii=False).encode('utf8')
